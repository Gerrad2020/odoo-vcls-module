...
![Screenshot pgadmin4](https://github.com/VCLS-org/odoo-vcls-module/blob/12.0-Documentations/Documentations/img/PostgreSQL_install2.JPG)<br/>

**General Tab** : Enter username: **odoo**<br/><br/>

![Screenshot pgadmin4](https://github.com/VCLS-org/odoo-vcls-module/blob/12.0-Documentations/Documentations/img/PostgreSQL_install3s1.jpg)<br/>

**Definition Tab**: Enter password **odoo**<br/><br/>

![Screenshot pgadmin4](https://github.com/VCLS-org/odoo-vcls-module/blob/12.0-Documentations/Documentations/img/PostgreSQL_install3s2.jpg)<br/>
...
- Once your first database created logout and go to database manager (http://"your_laptop_name":8069/web/database/manager)
- Set a master password (odoo)
![master password](https://github.com/VCLS-org/odoo-vcls-module/blob/12.0-Documentations/Documentations/img/set_master_password.png)

- Once it's done, stop the server using Ctrl + C
- launch these commands:
```
python odoo-bin --save --config odoo.conf --stop-after-init
